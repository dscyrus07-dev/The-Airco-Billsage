...
import {
  TrendingUp, TrendingDown, Calendar, FileText, Clock, CheckCircle,
  AlertTriangle, IndianRupee, BarChart3,
} from 'lucide-react';
...
export default function VendorInsightsTab({
  vendorId,
  invoices,
  isLoading = false,
      ...
      <div className="space-y-6">
        ...
        <Card className="p-8">
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-semibold mb-2">No Vendor Insights Available Yet</h3>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Vendor insights will appear once this vendor has purchase history and invoice data.
              Create purchase invoices for this vendor to see detailed analytics and trends.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="text-center p-4 border rounded-lg">
                <FileText className="h-8 w-8 text-blue-500 mx-auto mb-2" />
                <h4 className="font-medium mb-1">Purchase History</h4>
                <p className="text-sm text-muted-foreground">Track vendor transactions</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
  ...
  return (
    <div className="space-y-6">
      {/* Header with Summary */}
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Vendor Insights Summary</h3>
