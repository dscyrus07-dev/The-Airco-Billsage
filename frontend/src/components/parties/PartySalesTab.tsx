...
import {
  ...
  FileText, Filter, ChevronDown, DollarSign, CreditCard,
} from 'lucide-react';
...
export default function PartySalesTab({
  partyId,
  invoices,
  isLoading = false,
}: PartySalesTabProps) {
  ...
  const handleExport = () => {
    toast.success('Sales invoice data exported successfully');
  };
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {filteredInvoices.length} sales invoices found
            </p>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {salesInvoices.length === 0 
                ? "This party doesn't have any sales invoices yet."
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Receivable Days</TableHead>
